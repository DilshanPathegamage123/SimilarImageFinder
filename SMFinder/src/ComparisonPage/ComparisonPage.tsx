    ...
    <div className="App container-fluid">
      ...
      <div className=" row">
        ...
        <div className="UploadArea col col-12 col-md-2 me-4 ms-5 pb-4">
          {/* Dataset upload area */}
          <h5 className="mt-2 mb-4 text-white">Upload Here</h5>
          <UploadBox
          ...
          {dataset.length > 0 && (
            <div>
              <p className="mt-2 m-auto text-white UploadedCount">
                {dataset.length} images uploaded
              </p>
            </div>
          )}
        ...
        <div className="ResultArea col-12 col-md-9  ">
          <div className="row">
            <div className="Uploaded-img col-12 col-md-4  mb-3 ms-auto">
            ...
            <div className="search-results row col-12 col-md-7 ms-auto">
