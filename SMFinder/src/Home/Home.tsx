...
const Home = () => {
  return (
   ...
   <div className='row col-12'>
        ...
        <p className='heading2'>Upload a large image set and a reference image, quickly discover similar images with ease.

</p>
        </div>
        </div>

        <div className='btn button col-2 d-flex justify-content-center align-items-center m-auto'>
          <p >Get Started</p>
        </div>
        </div>
    </div>
